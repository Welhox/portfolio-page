...
function App() {
  ...
  <div className="bg-primary px-6 py-4 text-primary flex justify-between mb-8">
    <h1 className="text-xl font-semibold text-secondary font-artdeco tracking-wider"> &lt;〈CASIMIR LUNDBERG〉&gt;</h1>
